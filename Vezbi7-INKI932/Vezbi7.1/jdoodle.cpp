...
class date
{
    ...
    public:
    date(){}
    friend void operator>>(istream &in, date &d); //Overloading >> operator //// Friend funckija na klasa e definirana nadvor od klasata, no taa ima pravo da pristapi do site prvatni i zastiteni clenovi na klasata. ////
    friend void operator<<(ostream &out, date &d) //Overloading << operator //// Preku operator overloading mozeme da ja smenime funckijata na operatorite za da izvrsuvaat druga zadaca. ////
...
// https://www.programiz.com/cpp-programming/operator-overloading
{
    ...
    in>>d.month;
    cout<<"\n Enter Year : ";
    in>>d.year; // smeni in, shto se dobiva ? //// Se dobiva istiot rezultat, bidejki preku operator overloading ja smenivme funkcijata na operatorot " >> " da se vnesuva od input od korisnikot preku koristenje na " in ". ////
    cout<<"\n Enter Hour : ";
    in>>d.hour;
...
//Function for February Month. Checking whether the year is leap year or not.
    ...
    default: //// Del za proverka na mesecot ////
